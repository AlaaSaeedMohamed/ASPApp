...
namespace API.Data
{
    public class UserRepository : IUserRepository
    {
        ...
        public async Task<PagedList<MembersDto>> GetMembersAsync(UserParams userParams)
        {
            ...
            return await PagedList<MembersDto>.CreateAsync(query.AsNoTracking().ProjectTo<MembersDto>(_mapper.ConfigurationProvider), userParams.PageNumber, userParams.PageSize);
            }
